...
| `GET` | `/biologics/history/{order_id}` | Get history of an order by ID. | ```bash<br>curl "http://localhost:3000/api/bc/biologics/history/480f300b-38be-42d9-8e88-edc1f3364e37"<br>``` |
